...
enum RefitPath:
  case FullRefit
  case ExactReduced(algorithm: AlgorithmId)

final case class ExecutionProvenance(
    path: RefitPath,
    rootSeed: Seed,
    randomAlgorithm: AlgorithmId,
    seedDerivation: AlgorithmId
)

final case class ReplicateJob private[inference] (
    step: ComponentIx,
    withinStep: Int,
    replicate: ReplicateId
)

final case class ReplicateJobPlan private[inference] (
